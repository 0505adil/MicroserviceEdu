...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response) throws AuthenticationException {
        try {
           com.example.authservice.models.entities.User creds = new ObjectMapper().readValue(request.getInputStream(), com.example.authservice.models.entities.User.class);
            com.example.authservice.models.entities.User users = userService.findByLogin(creds.getLogin());
